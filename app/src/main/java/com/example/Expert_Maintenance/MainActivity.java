...
import com.example.Expert_Maintenance.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void syncData() {
        String url = "http://10.0.2.2/getAllData.php"; // Change to your server's address
    ...
    private void syncImages() {
        String url = "http://10.0.2.2/getImagesData.php"; // Replace with your server's IP or domain
